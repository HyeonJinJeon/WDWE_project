...
import MixinsPage from '../docs/categories/MixinsPage'
import DirectivesPage from '../docs/categories/DirectivesPage'
...
import DataTable2Page from '../docs/Tables/DataTable2Page'
...
import ScrollSpyPage from '../docs/Directives/ScrollSpyPage'
...
export default new Router({
  ...
  routes: [
    ...
    // FREE
    {
      ...
      path: '/directives/scrollspy',
      name: 'ScrollSpyPage',
      component: ScrollSpyPage
    },{
      path: '/directives/animate-on-scroll',
      name: 'AnimateOnScrollPage',
      component: AnimateOnScrollPage
    },{
      path: '/directives/waves',
      name: 'WavesDirectivePage',
      component: WavesDirectivePage
    },{
      path: '/mixins/class',
      name: 'ClassMixinPage',
